...
def build_argparser():
    ...
    parser.add_argument('--facem',
                        default='intel/face-detection-retail-0005/FP32/face-detection-retail-0005.xml',
    ...
    parser.add_argument('--headm',
                        default='intel/head-pose-estimation-adas-0001/FP32/head-pose-estimation-adas-0001.xml',
    ...
    parser.add_argument('--landm',
                        default='intel/facial-landmarks-35-adas-0002/FP32/facial-landmarks-35-adas-0002.xml',
    ...
    parser.add_argument('--gazem',
                        default='intel/gaze-estimation-adas-0002/FP32/gaze-estimation-adas-0002.xml',
...
if __name__ == '__main__':
    ...
    landmark_inputs.setInput('data', enhanced_g_in)
    ...
    ccomp.setSource(cv.gin(cv.imread(ARGUMENTS.input)))
    ...
    while True:
        ...
        if not video_object_created:
            fourcc = VideoWriter_fourcc(*'mp4v')
            output_video = VideoWriter(ARGUMENTS.out, fourcc, 5, (oimg.shape[1], oimg.shape[0]))
            video_object_created = True
